...
class CollectionController extends BaseController
{
    ...
    public function actionLink($tag)
    {
        ...
        \ZnYii\Web\Widgets\Toastr\Alert::create('Request was added to collection successfully.', Alert::TYPE_SUCCESS);
    ...
    public function actionUnlink($tag)
    {
        ...
        \ZnYii\Web\Widgets\Toastr\Alert::create('Request was removed from collection successfully.', Alert::TYPE_SUCCESS);
