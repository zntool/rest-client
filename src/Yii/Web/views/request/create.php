 ...
 * @var string $frame
 * @var \ZnTool\RestClient\Yii\Web\models\RequestForm $model
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="rest-request-form">
                <?= \ZnTool\RestClient\Yii\Web\Widgets\FormWidget::widget([
        ...
        <div class="col-lg-4">
            <?= \ZnTool\RestClient\Yii\Web\Widgets\CollectionWidget::widget([
                'projectId' => $projectEntity->getId(),
                'tag' => $tag,
            ]) ?>
        </div>
